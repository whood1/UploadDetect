"""
Django settings for UploadDetect project.
...
SECRET_KEY = '99!l7n_e5-cv!tvi^(-08j7n42fvc$@#g!#(lt@g&&yai)nm61'
...
ROOT_URLCONF = 'UploadDetect.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['UploadDetect/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
